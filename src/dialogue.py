...
gate_dialogue = {
    "initial": ["You awaken from a deep slumber, the sun shining brightly on your face.",
                "It was a good nap, but you must journey on.",
                "Looks like there is a nice pathway leading to the north...might be a good start?",
                "There is also the forest...but it looks pretty thick and hard to navigate...",
